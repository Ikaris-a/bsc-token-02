    ...
    <div class="width_1200">
      ...
      <div class="white-paper" v-if="this.$store.state.lang === 'JP'">
        <p>
          ...
          2 スターパワー：<br />
          SSR（カード25枚、キャラクター5人 合計：5セット）
          プールの10％を受け取る龙珠卡
          1日1回、7枚のチケットを集めて、連続で30％の賞品をゲットしよう
          7日後に自動的に再プールされる
          <br />
          プレッジカードマイニングDBFZ誓約書カードマイニングトークン
          採掘に取り組む総量は1000W（1年間に採掘される量
          プレッジマイニングは、総バトルバリューに対するユーザーバトルバリューの数に比例して割り当てられる
          遊び方の詳細は、白書の2回目の追加で説明しています
          <br />
          NFTとDefiによる分散型金融の実現
